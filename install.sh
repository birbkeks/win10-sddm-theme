...
function edit() {
    ...
    sudo sed -i 's/Current=/Current=win10-sddm-theme/' /etc/sddm.conf.d/kde_settings.conf

    else

    sudo sed -i 's/Current=/Current=win10-sddm-theme/' /etc/sddm.conf
...
function user() {
    ...
    sudo wget -P /usr/share/sddm/faces/ https://raw.githubusercontent.com/birbkeks/win10-sddm-theme/main/user-192.png -nc
